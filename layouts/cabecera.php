            ...
            <div class="top-wrap">
                <a class="custom-logo-link" href="#">
                    <a href="#" class="custom-logo-link" rel="home" aria-current="page">
                        <img width="281" height="100" src="https://www.distriserviciosesp.com/wp-content/uploads/2020/08/Icon2-1-1536x265.png" class="custom-logo style-svg" alt="Gola" decoding="async" />
                    </a>
                </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarColor01">
                <ul id="primary-menu" class="navbar-nav" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                    <li id="menu-item-27774" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-27774 nav-item">
                        <a itemprop="url" href="index.php" class="nav-link"><span itemprop="name">Home</span></a>
                    </li>
