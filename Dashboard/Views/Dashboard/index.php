              ...
              <div class="card-body">
                <div class="d-md-flex justify-content-between mb-9">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                      <a href="javascript:void(0)" class="btn border-dark-subtle shadow-none px-3" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <table class="table align-middle text-nowrap">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center text-truncate">
                            <img src="../assets/images/profile/user-2.jpg" alt="spike-img" class="img-fluid rounded-circle flex-shrink-0" width="40" height="40">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center text-truncate">
                            <img src="../assets/images/profile/user-3.jpg" alt="spike-img" class="img-fluid rounded-circle flex-shrink-0" width="40" height="40">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center text-truncate">
                            <img src="../assets/images/profile/user-4.jpg" alt="spike-img" class="img-fluid rounded-circle flex-shrink-0" width="40" height="40">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center text-truncate">
                            <img src="../assets/images/profile/user-5.jpg" alt="spike-img" class="img-fluid rounded-circle flex-shrink-0" width="40" height="40">
                            <div class="ms-3">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center text-truncate">
                            <img src="../assets/images/profile/user-6.jpg" alt="spike-img" class="img-fluid rounded-circle flex-shrink-0" width="40" height="40">
                            <div class="ms-3">
